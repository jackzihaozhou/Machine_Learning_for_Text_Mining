# -*- coding: utf-8 -*-
"""
Created on Mon Feb 24 22:20:59 2020
...
#import scipy
import time
from Create_matrix import create_PCC_matrix
...
mean_write_prediction("../eval/PCC_pro_mean_moviemovie_10.txt",pro_movie_topk_10,10)


pro_movie_topk_100,movie_sim_value = find_movie_topk(100,pro_movie_movie_matrix,dev_query_movie_list)
mean_write_prediction("../eval/PCC_pro_mean_moviemovie_100.txt",pro_movie_topk_100,100)

pro_movie_topk_500,movie_sim_value = find_movie_topk(500,pro_movie_movie_matrix,dev_query_movie_list)
mean_write_prediction("../eval/PCC_pro_mean_moviemovie_500.txt",pro_movie_topk_500,500)


cos_movie_topk_10,movie_sim_value = find_movie_topk(10,cos_movie_movie_matrix,dev_query_movie_list)
mean_write_prediction("../eval/PCC_cos_mean_moviemovie_10.txt",cos_movie_topk_10,10)
weighted_write_prediction("../eval/PCC_cos_weighted_moviemovie_10.txt",cos_movie_topk_10,movie_sim_value,10)

cos_movie_topk_100,movie_sim_value = find_movie_topk(100,cos_movie_movie_matrix,dev_query_movie_list)
mean_write_prediction("../eval/PCC_cos_mean_moviemovie_100.txt",cos_movie_topk_100,100)
weighted_write_prediction("../eval/PCC_cos_weighted_moviemovie_100.txt",cos_movie_topk_100,movie_sim_value,100)
'''
cos_movie_topk_500,movie_sim_value = find_movie_topk(500,cos_movie_movie_matrix,dev_query_movie_list)
#mean_write_prediction("../eval/PCC_cos_mean_moviemovie_500.txt",cos_movie_topk_500,500)
weighted_write_prediction("../eval/PCC_cos_weighted_moviemovie_500.txt",cos_movie_topk_500,movie_sim_value,500)
