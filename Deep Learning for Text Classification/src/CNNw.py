'''
Here is training process for CNN w pretrained embed
'''
...
def CNNw():
    mkdir("result")
    mkdir("model")
    ftest_loss = open("result/CNNw_test_loss.txt","w")
    ftest_acc = open("result/CNNw_test_accuracy.txt","w")
    ftrain_loss = open("result/CNNw_train_loss.txt","w")
    ftrain_acc = open("result/CNNw_train_accuracy.txt","w")
